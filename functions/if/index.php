<?php
	...
	*/
	...
	if ($a == 2 and $b < $c){
		echo 'код виконуэться бо умови - true' . "<hr />";

	}

	if ($a == 2 and $b < $c and $c < $a){
		echo 'код не виконається , бо умови є false ($c більше $a)';
	}
		echo "<hr />";

	if ($a == 2 or ($b < $c and $c < $a)) {
		echo 'виконаэться , бо умова true (не дивлячись на false  після or)';
